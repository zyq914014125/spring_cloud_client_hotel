...
public class shiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter() {
        ...
        // 设置login URL
        shiroFilterFactoryBean.setLoginUrl("/travel");
        // 登录成功后要跳转的链接
        shiroFilterFactoryBean.setSuccessUrl("/travel");
        // 未授权的页面
        ...
        filterChainDefinitionMap.put("/travel/routes", "anon");
        filterChainDefinitionMap.put("/routes", "anon");
        filterChainDefinitionMap.put("/sceneries", "anon");
        filterChainDefinitionMap.put("/routes/**", "anon");
        filterChainDefinitionMap.put("/scenery/**", "anon");
